          ...
          <View style={[styles.cardPlaca, styles.shadow]} key={item.id}>
            ...
            <View style={styles.cardRight}>
              <TouchableOpacity
                style={[
                  styles.acaoPlaca,
                  { backgroundColor: item.status === "Ativa" ? "#ffc125" : "#F3F4F6" },
                ]}
                onPress={() => alternarStatus(item.id)}
                activeOpacity={0.8}
              >
                <MaterialIcons name="power-settings-new" size={22} color={item.status === "Ativa" ? "#000" : "#6B7280"} />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  loading: { flex: 1, justifyContent: "center", alignItems: "center", backgroundColor: "#FBFBFF" },
